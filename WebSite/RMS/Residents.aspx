             ...
             <%--<tr>
              ...
              <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" runat="server" id="txtRemarks" placeholder="Enter Employee Remarks" class="req"/>
                    </td>
                </tr>
                <tr>
        ...
        <script type="text/javascript">
            ...
            function uploadComplete2(sender, args) {
                ...
                if (a == '') {
                    ...
                    img.src = "<%=ResolveUrl(UploadFolderPath) %>" + name + ".jpg" + "?v=" + Date.now();// args.get_fileName();  
                    console.log(img.src + "");
