...
<%--                        Page.Response.Write("<script>console.log('"+dt+"')</script>");      --%>
                        <td class="newImage"> <img  src='../RMS/EmpPictures/<%# Eval("PHOTO") %>.jpg?v=<% DateTime dt = DateTime.Now; Page.Response.Write(dt); %>' height="50px" width="50px"/>
                        </td>
